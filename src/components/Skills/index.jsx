...
import postgree from '../../assets/postgree.png'
...
function Skills() {
  return(
    <Container id='skills'>
        <motion.div initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} transition={{duration: 3}}>
            <div className='skills__left'>
                ...
                <div className='card__container'>
                    ...
                    <div className='card'>
                        <img src="https://cdn.iconscout.com/icon/free/png-256/css3-11-1175239.png" alt="" />
                        <h3>CSS</h3>
                    </div>
        ...
        <motion.div initial={{left: '55%'}} whileInView={{left: '15rem'}} transition={{duration: 1, type: 'string'}}>
